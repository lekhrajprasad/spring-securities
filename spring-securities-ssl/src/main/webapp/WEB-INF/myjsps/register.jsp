	...
	<div class="card">
		<div class="card-body">
			<div class="container" align="center">
				...
				<div class="container">
					<form:form action="registerMyUser" method="post" modelAttribute="myuser">
						<table class="table">
							...
							<tr>
								<td>Password</td>
								<td><form:password path="password" class="form-control form-control-lg"/></td>
							...
							<tr>
								...
								<input type="submit" value="Register Now" class="btn btn-primary btn-lg"/>
								</td>
							</tr>
						</table>
					</form:form>
				...
				<div class="container">
					<h2>
						<b><a href='<c:url value="login"/>'>Already Registered Login Here</a></b>
					</h2>
				</div>
			</div>
		</div>
